        ...
        <div class="ui centered grid">
            ...
            <div class=" flex flex-col justify-center items-center gap-y-5 h-[calc(100vh_-_74px)] w-full">
                    ...
                    <form method="post" action="session/store" class="flex flex-col justify-center items-center gap-y-3">
                        <input id="email" class="input border-2 border-black rounded-md pl-3" autocomplete="off" type="email" name="email" placeholder="Digite o Email" value="n3586@hotmail.com"  />
                        <div class="text-red-500 font-bold"><?= $formErrors["email"] ?></div>
                        <input id="password" class="input border-2 border-black rounded-md pl-3" autocomplete="off" type="password" name="password" placeholder="Digite a senha"  value="1234"/>
            ...
            <section class="computer only row w-full">
                <div class=" flex flex-col justify-center items-center gap-y-5 h-[calc(100vh_-_74px)] w-full">
                    ...
                    <form method="post" action="session/store" class="flex flex-col justify-center items-center w-3/12 gap-y-3">
                        <input id="email" class="input border-2 border-black rounded-md w-full pl-3" autocomplete="on" type="email" name="email" placeholder="Digite o Email"  value="n3586@hotmail.com"/>
                        <div class="text-red-500 font-bold"><?= $formErrors["email"] ?></div>
                        <input id="password" class="input border-2 border-black rounded-md w-full pl-3" autocomplete="off" type="password" name="password" placeholder="Digite a senha"  value="1234"/>
                        <div class="text-red-500 font-bold"><?= $formErrors["password"] ?></div>
                        <button type="submit" class="cursor-pointer text-xl bg-black text-white w-20 text-center my-3 rounded-md">Entrar</button>
                        <div class="text-red-500 font-bold"><?= $warningAcess ?></div>
                    </form>
