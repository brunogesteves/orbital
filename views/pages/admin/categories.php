...
<div class="mx-auto mt-2 flex">
    ...
    ?>
    <main class="w-full max-[768px]:w-full flex justify-center flex-col items-center  h-[calc(100vh_-_261px)]">
        ...
        <div
            class=" w-full flex flex-col justify-start items-center min-[768px]:h-[calc(100vh_-_261px)] overflow-y-auto">

            <?php foreach ($AllCategories as $cat): ?>
                <div class="w-1/4 max-[767px]:w-full h-auto  p-1 flex justify-between gap-x-10 uppercase">
