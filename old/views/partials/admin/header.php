...
<body>
    ...
    <header class="flex justify-between items-center px-2 py-2 max-[992px]:flex-col max-[992px]:gap-y-5">
        ...
        <img src="../images/icons/menu.svg" alt="logo" class="rounded-full mt-3 mt-1 w-7 h-7 min-[992px]:hidden " id="menu_mobile_open" />
