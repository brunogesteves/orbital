...
class AutomaticPosts
{
    ...
    public function index()
    {
        ...
        curl_setopt_array($curl, [
            CURLOPT_URL => "https://free-news.p.rapidapi.com/v1/search?q=esporte&lang=pt",
        ...
        $title = trim($article[1]->title);
        $link = $article[1]->link;
        $content = trim($article[1]->summary);
        $source = $article[1]->clean_url;
        $slug = trim(self::createSlug($article[1]->title));
        $image = $article[1]->media;
