<main class="w-full min-h-[calc(100vh_-_280px)]">
    ...
    <div class="ui active tab" data-tab="front">
        ...
        <div class="flex flex-col ads overflow-y-auto h-96">
            <?php
            foreach ($frontAds as $ad) : ?>
                <div class="px-5">
                    <img src="../images/ads/<?= $ad['file'] ?>" class=" w-full object-fit object-center" />
                    <div class="flex justify-between items-center h-auto flex-col w-full my-2 px-3 py-2 gap-x-1 ">
                        <p class="w-auto ">
                            <?= $ad["name"] ?>
                        </p>
                        <p class="w-auo">
    ...
    <div class="ui tab" data-tab="slide">
        <!-- Tab Content !-->
        <button class="openNewModalbtn text-white bg-black my-7 p-2 ml-4 rounded-lg text-xl">Adicionar Anúncio</button>
        <div class="flex flex-col ads overflow-y-auto h-96">
            <?php
